...
import ui.attendance_module.ResponseHandler;
...
public class TeacherUploadAssignment extends javax.swing.JFrame {
    ...
    public TeacherUploadAssignment() {
        initComponents();
        controller=ObjectsFactory.getinstanceofAssignmentController();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Cloud Storage URL");
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(url, javax.swing.GroupLayout.PREFERRED_SIZE, 355, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addComponent(Ass, javax.swing.GroupLayout.DEFAULT_SIZE, 108, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        ...
        record.TeacherID=teacher_id.getText();
        record.date= sdf.format(date.getDate());
        record.url=url.getText();
        record.ass_num=Integer.parseInt(Ass.getText());
        
        
     Response response=   controller.CUploadAssignment(record);
     
        ResponseHandler.handelresponse(response,url);
